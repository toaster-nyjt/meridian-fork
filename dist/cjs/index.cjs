...
var OverviewBasicList = function (options) {
    var _a;
    return (jsxRuntime.jsx("div", { className: "overview-basic", children: jsxRuntime.jsx("div", { className: "overview-basic-container ".concat((_a = options.overview.className) !== null && _a !== void 0 ? _a : ''), style: options.overview.style, children: options.items.map(function (item, index) { return (jsxRuntime.jsx(MeridianItem, { options: options, item: item, itemView: options.overview.itemView, index: index, className: options.overview.itemClassName, style: options.overview.itemStyle }, index)); }) }) }));
};
...
var MeridianOverview = function (_a) {
    ...
    return (jsxRuntime.jsxs("div", { children: [jsxRuntime.jsx("div", { className: "flex flex-col", children: enabledMalleability() && (jsxRuntime.jsx(MalleabilityOvervewTabs, {})) }), odi.overviews
    ...
    return (jsxRuntime.jsxs("div", { 
        ...
        className: "".concat(className), style: __assign({ cursor: detailToOpen && !highlightAttributes ? "pointer" : "auto" }, style), onClick: function (e) {
            ...
            if ((detailToOpen === null || detailToOpen === void 0 ? void 0 : detailToOpen.openIn) === "new-page") {
                ...
                (selectedItemEntity === null || selectedItemEntity === void 0 ? void 0 : selectedItemEntity.detail.openIn) === "tooltip" && (jsxRuntime.jsx("div", { className: "absolute w-100 max-h-125 bg-white shadow-2xl h-[96%] rounded-md z-10 overflow-scroll", style: {
                    left: "calc(50% - 200px)",
                    top: -520,
...
var OverviewBasicGrid = function (options) {
    var _a;
    return (jsxRuntime.jsx("div", { className: "overview-basic-grid", children: jsxRuntime.jsx("div", { className: "overview-basic-container ".concat((_a = options.overview.className) !== null && _a !== void 0 ? _a : ''), style: options.overview.style, children: options.items.map(function (item, index) { return (jsxRuntime.jsx("div", { className: "overview-basic-item", children: jsxRuntime.jsx(MeridianItem, { options: options, item: item, itemView: options.overview.itemView, index: index, className: options.overview.itemClassName, style: options.overview.itemStyle }) }, index)); }) }) }));
};
...
var OverviewBasicMap = function (options) {
    ...
    return (jsxRuntime.jsx("div", { className: "w-full h-full flex flex-col items-center py-8 px-8 ".concat((_c = options.overview.className) !== null && _c !== void 0 ? _c : ''), style: options.overview.style, children: jsxRuntime.jsx("div", { className: "w-full h-screen overflow-hidden rounded-3xl", children: jsxRuntime.jsx(reactGoogleMaps.APIProvider, { apiKey: googleMapsAPIKey !== null && googleMapsAPIKey !== void 0 ? googleMapsAPIKey : "", children: jsxRuntime.jsx(reactGoogleMaps.Map, { mapId: googleMapsAPIId, style: {
                        width: "100%",
                        height: "100%",
                    }, 
                    // className="gm-style"
                    defaultCenter: defaultCenter, defaultZoom: defaultZoom, children: coordinates &&
                        options.items.map(function (item, index) {
                            ...
                            return (jsxRuntime.jsx(reactGoogleMaps.AdvancedMarker, { position: position, zIndex: hoveredItemId === (item === null || item === void 0 ? void 0 : item.itemId) ? 6 : 3, children: jsxRuntime.jsx("div", { className: "w-fit max-w-125 bg-white border border-gray-400 rounded-2xl shadow-md shadow-black/40\n                      transition ".concat(detailToOpen && !highlightAttributes
                                    ...
                                    }, onMouseOver: function () { var _a; return setHoveredItemId((_a = item === null || item === void 0 ? void 0 : item.itemId) !== null && _a !== void 0 ? _a : ""); }, children: jsxRuntime.jsx(MeridianItem, { item: item, options: options, index: index, itemView: options.overview.itemView, className: options.overview.itemClassName, style: options.overview.itemStyle }) }) }, "".concat(item === null || item === void 0 ? void 0 : item.itemId, "-").concat(index)));
                        }) }, "map" + mapOverview.id) }) }) }));
};
...
var OverviewBasicTable = function (options) {
    ...
    var detailToOpen = findItemDetailViewToOpen(options, odi);
    return (jsxRuntime.jsx("div", { className: "overview-basic overview-basic-table ".concat((_a = options.overview.className) !== null && _a !== void 0 ? _a : ''), style: options.overview.style, children: jsxRuntime.jsx("div", { className: "table-container", children: jsxRuntime.jsxs("table", { children: [jsxRuntime.jsx("thead", { children: jsxRuntime.jsx("tr", { children: headerInfo.map(function (header, index) { return (jsxRuntime.jsx("th", { children: header.headerText }, index)); }) }) }), jsxRuntime.jsx("tbody", { children: options.items.map(function (item, index) { return (jsxRuntime.jsx("tr", { className: options.overview.itemClassName, style: __assign({ cursor: detailToOpen && !highlightAttributes ? "pointer" : "auto" }, options.overview.itemStyle), onClick: function (e) {
                                var _a, _b;
                                if (detailToOpen && !highlightAttributes) {

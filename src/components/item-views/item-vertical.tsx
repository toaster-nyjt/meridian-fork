...
export const ItemVertical = ({
  ...
  return (
    <div className={`item-view item-vertical ${className}`} style={style}>
      ...
      <div className="content-area">
        <div className="header-area">
              ...
              (role) =>
                getAttributesByRole(item, role as Role) && (
                  <Attribute
                    key={role}
                    className={
                      role === "description" ? "description" : "key-attribute  "
                    }
                    options={options}
                    attribute={getAttributesByRole(item, role as Role)}
                  />
          ...
          {/* {unlabeledAttributes.length > 0 && (
            <div className="column gap-1 sm unlabeled">
